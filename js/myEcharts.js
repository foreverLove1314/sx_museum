$(function () {
    ...
    var myChart = echarts.init(document.getElementsByClassName('env_li_play')[0]);
    myChart.setOption(option);
    var myChart2 = echarts.init(document.getElementsByClassName('env_li_play')[1]);
    myChart2.setOption(option);
    var myChart3 = echarts.init(document.getElementsByClassName('env_li_play')[2]);
    myChart3.setOption(option);
    var myChart4 = echarts.init(document.getElementsByClassName('env_li_play')[3]);
